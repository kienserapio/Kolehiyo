import heroImage from "@/assets/college_image.png";
      ...
      {/* Content */}
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <span className="block">
                Find the <span className="text-[#FBB507]">College</span> for You!
            </span>
            </h1>

            <p className="text-[18px] md:text-[20px] text-white/95 mb-10 max-w-4xl mx-auto font-medium">
            View any incoming or open college admission that suits your future program.
            </p>
